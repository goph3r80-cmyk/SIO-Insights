...
window.SIO_DATA = {
  ...
  "changelog": [
    ...
    {
      "date": "2026-09-05",
      "note": "Doctrine-spine update (no evidence changes): DCM/ACDOM promoted from landing-zone routing into the doctrine spine — the lifecycle now defines what information each decision instrument needs and what actions implement it (DOCTRINE.md §29 rewritten with rule 6, the information-and-action ladder; per-phase information requirements added to the capdev-governance skill; instrument-readiness made a standing officer rule). Applied to the live register: D-1 and D-2 recommendations now close with their instrument-readiness ladder — for both, the graded external trend requirement is satisfied and the binding open item is the deficiency statement, which only the directed G5 baselines (due 15 Sep) can supply. This makes explicit in-data what the doctrine already held: the baselines are the fuel, and the next instrument’s open requirements are the tasking list."
    },
    {
      "date": "2026-09-05",
  ...
  "serials": [
    {
      ...
      "recommendation": "Endorse affordable layered counter-UAS as an Army force-development priority. Direct the G5 force-development element to establish the Army requirement and integrated capability roadmap, with ASB2 as functional lead for counter-UAS / Sense-Strike analysis and other relevant C2, EW, protection, logistics, acquisition and technical stakeholders supporting as G5 identifies. The immediate deliverable is an Army C-UAS force-development baseline; a layered trial is proposed only after that baseline confirms residual gaps and defines the trial questions. Instrument-readiness (AOR/SON via ACDM): SATISFIED — threat/technology trend and trajectory, graded with confidence (this thread's evidence base); OPEN — the deficiency statement, which requires the confirmed internal C-UAS baseline (G5 action, due 15 Sep 2026); OPEN — options comparison and total-cost bases at Army scale (follows the baseline; ASB2 functional lead with AOTO cost-basis discipline); OPEN — sustainment and manpower implications per layer (CESS input once candidate layers are scoped). No AOR entry is possible, and none is sought, before the baseline closes the deficiency requirement.",
      ...
      "src": [
        ...
        },
        {
          ...
          "date": "13 Aug 2026",
          "ttl": "WSJ: Ukrainian drone operators 'easily defeated' U.S. troops in military exercise",
          "url": "https://meduza.io/en/news/2026/08/13/wsj-ukrainian-drone-operators-easily-defeated-us-troops-in-military-exercise",
          "f": "verified",
          "note": "WSJ original paywalled; corroborated by Liga.net, RBC-Ukraine and To Vima syndications."
        },
        {
          "out": "Aviation Week",
          "date": "13 Aug 2026",
        ...
        },
        {
          ...
          "date": "21 Aug 2026",
          "ttl": "JIATF-401 Counter-UAS and Critical Infrastructure Protection Media Roundtable",
          "url": "https://www.army.mil/article/294836/jiatf_401_counter_uas_and_critical_infrastructure_protection_media_roundtable_august_21_2026",
          "f": "verified"
        },
        {
          "out": "DefenseScoop",
          "date": "2 Sep 2026",
          "ttl": "Army awards AeroVironment nearly $500M contract for laser weapons",
      ...
      "targetForum": "ACDM",
      "latestDevelopment": "The Army awarded AeroVironment $464.8M under E-HEL for LOCUST X3 30kW counter-drone lasers (2 Sep) — reported as the first HEL production contract in US history, converting the JIATF-401 pilot this thread logged on 21 Aug into a funded production line; separately, a year-long directed-energy counter-drone trial series across five military bases is reported underway.",
      "changeFromPrevious": "Material since last review: the DE layer of the layered C-UAS architecture crossed a maturity threshold — from pilot/prototype to production contract (resourcing fact, corroborated). This strengthens the external side of the instrument-readiness ladder but changes nothing on the open items: the G5 baseline (suspense 15 Sep 2026) is now PAST DUE with no internal input received in this pipeline — the deficiency statement remains the binding open requirement, and the overdue suspense is itself reportable."
    },
    {
      "id": "D-2",
      "category": "capability",
      ...
      "suspense": "15 Sep 2026",
      "recommendation": "Endorse spectrum survivability and low-signature operation as Army C2 force-development requirements. Direct the G5 force-development element to establish the current baseline, the affected capability lines and the required design standards, with the relevant C2, EW, communications and operational stakeholders contributing. No funded-programme approval is sought before the baseline, scope and resource implications are known. Instrument-readiness (requirements entry into OCF/AOR machinery via ACDM): SATISFIED — the external evidence that spectrum survivability is a validated operational requirement in contested environments; OPEN — the deficiency statement, requiring the confirmed C2 spectrum-survivability baseline (G5 action, due 15 Sep 2026); OPEN — the measurable design standards a SOR would carry (follows the baseline); OPEN — affected capability lines and their upgrade cost bases. No funded-programme step precedes the baseline.",
    ...
    },
    {
      ...
      "src": [
        ...
        },
        {
          ...
          "date": "15 Sep 2026",
          "ttl": "AI Policy Corner: The UN and the Future of Military AI Governance",
          "url": "https://montrealethics.ai/ai-policy-corner-the-un-and-the-future-of-military-ai-governance/",
          "f": "verified",
          "note": "Secondary policy brief; primary GGE session documents to be cited in staff work."
        }
      ],
      "insightSponsor": "SIO",
      ...
      "nextInstrument": null,
      "targetForum": null,
      "latestDevelopment": "The CCW GGE on LAWS (Geneva, 31 Aug–4 Sep) produced agreed elements across 128 parties: a working characterisation of LAWS (systems that identify, select and engage targets without a human operator performing those tasks) and affirmation that IHL applies — non-binding, with required levels of human involvement unresolved. The November CCW Review Conference decides whether negotiation of an instrument is mandated (76 states in favour; US and Russia opposed).",
      "changeFromPrevious": "Evidence-base update with a dated trigger: the multilateral floor under Q6 firmed for the first time (an agreed characterisation exists, even non-binding), and the November Review Conference is now a calendar event any Army position input should precede. This staff action's 15 Sep suspense has PASSED with no completion evidence received in this pipeline — overdue, and the November date sharpens why it matters."
    },
    {
      "id": "W-1",
      "category": "capability",
      ...
      "src": [
        ...
        },
        {
          "out": "Naval News",
          "date": "11 Aug 2026",
          "ttl": "HII Watcher Autonomous USV Passes Critical DIU Performance Tests",
    ...
    },
    {
      ...
      "suspense": "Trigger-based — see escalationTrigger",
      "latestDevelopment": "Scale data attributed to Ukraine's DELTA system: ~112,000 UGV logistics/casevac missions since January (25,000+ in August alone), ~25,000 UGVs contracted in H1 2026 toward a stated 100%-robotic frontline-logistics goal (United24, ~8 Sep; state-linked, not independently audited). Separately the US Army awarded Rheinmetall a hybrid logistics UGV contract for battlefield resupply (~10 Sep) — a comparator force moving from trials to procurement in the last-mile role.",
      "changeFromPrevious": "Material since last review: the last-mile sustainment case moved on both evidence axes — employment scale (112k missions YTD, if DELTA figures hold) and comparator-force commitment (a US production-track logistics-UGV award). The task-share finding (19 of 20 UGV tasks are sustainment/evac) now sits on mission volume, not anecdote. No Army trigger met: the escalation condition remains a G5-framed last-mile requirement or a sponsored trial, and the burden-data precondition from the process owners still stands.",
      ...
      "src": [
        ...
        {
          "out": "War on the Rocks",
          "date": "2 Sep 2026",
          "ttl": "Ukraine's Ground Robots and the Economics of Survival",
          "url": "https://warontherocks.com/ukraines-ground-robots-and-the-economics-of-survival/",
          "f": "verified",
          "note": "Date approximate; unit-reported task-share figures."
        },
        {
          "out": "United24 Media",
          "date": "8 Sep 2026",
          "ttl": "Ukraine's Ground Robots Complete 112,000 Logistics and Evacuation Missions in 2026",
          "url": "https://united24media.com/war-in-ukraine/ukraines-ground-robots-complete-112000-logistics-and-evacuation-missions-in-2026-22306",
          "f": "verified",
          "note": "State-adjacent outlet relaying DELTA figures; date approximate; unaudited."
        },
        {
          "out": "Army Recognition",
          "date": "10 Sep 2026",
          "ttl": "U.S. Army Awards Rheinmetall Hybrid Logistics UGV Contract for Battlefield Resupply",
    ...
    },
    {
      ...
      "suspense": "Trigger-based — see escalationTrigger",
      "latestDevelopment": "South Korea's Army Headquarters commissioned a study to automate field maintenance and logistics under ArmyTiger L — AI predictive maintenance (small language models), maintenance robots, exoskeletons, automated storage/handling, drone delivery and autonomous transport — explicitly driven by a sustained decline in available personnel; its 1st Supply Group unveiled a smart logistics centre with ~70% of processes automated (Korea Herald, 12 Aug). Vendor-side, Lockheed Martin is extending AI sustainment (predictive maintenance, supply forecasting) from the F-35 to the F-22/F-16/C-130 fleets (11 Aug).",
      "changeFromPrevious": "Material since 8 Aug review: the ROK Army study is the problem-first pattern this line calls for — starting from a measured manpower decline, not a technology — from a conscription-based force facing constraints comparable to Singapore's. It provides a concrete comparator for which processes an army automates first and why.",
      "armyRelevance": "Problem-first: the Army question is which inventory/logistics/maintenance processes carry the largest manpower burden, error rate or reconciliation effort — established from Army process data, not inferred. The ROK Army's manpower-driven automation study is a directly comparable force answering the same question and is now the line's primary comparator; the MARSOC armory and Lockheed sustainment-AI items are candidate-technology evidence. No Army process baseline is held by this pipeline.",
      ...
      "signal": "[Reported] MARSOC and SOFWERX are developing an RF-free 'automated armory' that uses computer vision to track serialized weapons and inventory without tags or manual counts (DefenseScoop, 28 Jul) — commercial computer-vision inventory technology applied to a fixed military logistics process. [Reported — corroborated] South Korea's Army commissioned an automation study for field maintenance and logistics (ArmyTiger L; smart logistics centre ~70% automated) explicitly to offset a shrinking personnel pool (Korea Herald, 12 Aug). [Reported — vendor] Lockheed Martin is extending AI-driven sustainment from F-35 to F-22/F-16/C-130 fleets (11 Aug) — sustainment AI crossing from single-programme to fleet-wide practice.",
      ...
      "src": [
        ...
        {
          "out": "The Korea Herald",
          "date": "12 Aug 2026",
          "ttl": "Army seeks to automate field maintenance as staff shrinks",
          "url": "https://www.koreaherald.com/article/10838963",
          "f": "verified",
          "note": "Corroborated by Inquirer.net, TRT and Asia News Network syndications."
        },
        {
          "out": "Defence Industry Europe",
          "date": "11 Aug 2026",
          "ttl": "Lockheed Martin expands AI-driven military logistics from F-35 to F-22, F-16 and C-130 fleets",
          "url": "https://defence-industry.eu/lockheed-martin-expands-ai-driven-military-logistics-from-f-35-to-f-22-f-16-and-c-130-fleets-to-strengthen-aircraft-readiness/",
          "f": "verified",
          "note": "Vendor claims — no independent performance validation; primary source: Lockheed Martin feature."
        }
      ],
      "question": "Q4",
      "decisionLog": [],
    ...
    },
    {
      ...
      "src": [
        ...
        {
          "out": "GovCIO Media & Research",
          "date": "12 Aug 2026",
          "ttl": "Military Leaders Say AI Needs Better Data to Reach the Battlefield",
    ...
    },
    {
      ...
      "suspense": "Trigger-based — see escalationTrigger",
      "latestDevelopment": "The PLA's 3 Sep V-Day parade publicly displayed GJ-11-class stealth combat drones (presented in a manned-unmanned teaming role), an AJX002-class extra-large UUV, high-energy-laser counter-drone systems, electronic-jamming systems and new hypersonic/strategic weapons — staged with the Russian and DPRK heads of state present.",
      "changeFromPrevious": "Material since last review: the parade is the period's defining signalling event — a deliberate deterrence communication that also confirms counter-unmanned, directed-energy and unmanned deep-strike as showcased PLA force categories, and puts several previously glimpsed systems (GJ-11, extra-large UUV) on public display for the first time. Graded strictly: paraded = reported — display evidences existence and doctrinal priority, not fielded performance; individual system status requires independent corroboration.",
      ...
      "src": [
        ...
        },
        {
          "out": "South China Morning Post",
          "date": "12 Aug 2026",
          "ttl": "Satellite images show 50 per cent boost to China's Type 054B missile capacity",
        ...
        },
        {
          "out": "CBS News",
          "date": "3 Sep 2026",
          "ttl": "What weapons China showed off in its military parade as Xi Jinping, Vladimir Putin and Kim Jong Un watched",
          "url": "https://www.cbsnews.com/news/china-military-parade-new-weapons-pictures-laser-icbm-ai-drones-missiles-xi-jinping/",
          "f": "verified",
          "note": "Western press-pool coverage; corroborated across outlets. Paraded systems graded reported."
        },
        {
          "out": "Jamestown Foundation",
          "date": "2 Sep 2026",
          "ttl": "Guns of September: What a Parade May Reveal About China’s Military Modernization",
          "url": "https://jamestown.org/guns-of-september-what-a-parade-may-reveal-about-chinas-military-modernization/",
          "f": "verified",
          "note": "Analytical framing of the parade’s modernization signals; date approximate."
        },
        {
          "out": "Asia Times",
          "date": "9 Sep 2026",
          "ttl": "China launching multidomain drone swarms for next-gen warfare",
          "url": "https://asiatimes.com/2026/09/china-launching-multidomain-drone-swarms-for-next-gen-warfare/",
          "f": "verified",
          "note": "Relays CETC/NUDT claims; date approximate."
        }
      ],
      "insightSponsor": "SIO",
  ...
  "feed": [
    {
      ...
      "out": "Montreal AI Ethics Institute",
      "ttl": "AI Policy Corner: The UN and the Future of Military AI Governance",
      "sum": "The 128 CCW parties, at the final 2026 GGE session on lethal autonomous weapons (Geneva, 31 Aug–4 Sep), agreed non-binding foundational elements: LAWS characterised as systems that can identify, select and engage targets without a human operator carrying out those tasks, with IHL affirmed as applying — while required levels of human involvement in targeting were left unresolved. The November CCW Review Conference decides whether a mandate to negotiate an instrument follows; 76 states support binding negotiations, the US and Russia oppose.",
      "tech": [
        "ai",
        "robo"
      ],
    ...
    },
    {
      ...
      "out": "Army Recognition",
      "ttl": "U.S. Army Awards Rheinmetall Hybrid Logistics UGV Contract for Battlefield Resupply",
      "sum": "The US Army awarded Rheinmetall a contract for hybrid logistics UGVs for battlefield resupply — a comparator-force procurement entry (not a trial) in exactly the last-mile sustainment role the Ukrainian task-share data identifies as the dominant real-world UGV employment.",
      "tech": [
        "robo"
      ],
      "pf": "P7",
      ...
      "confidence": "moderate",
      "primarySourceUrl": null,
      "unverifiedClaims": "Single trade-press sighting in this sweep; date approximate; contract value and quantities not captured — corroborate against official announcement before any cost figure is used.",
      "dateLastChecked": "2026-09-18"
    },
    {
      "date": "2026-09-09",
      "out": "Asia Times",
      "ttl": "China launching multidomain drone swarms for next-gen warfare",
      "sum": "A CETC Intelligent Technology Research Institute assessment describes PLA-linked development moving from homogeneous aerial swarms to multidomain integration of autonomous land, sea and air platforms; CETC claims one-operator control of a 96-drone swarm, and NUDT footage earlier in 2026 showed a single operator launching 200+ fixed-wing drones with autonomous task-sharing and anti-jamming claims. Xi has publicly directed accelerated military-AI integration toward an 'intelligent military system'.",
      "tech": [
        "ai",
        "robo"
      ],
      ...
      "confidence": "moderate",
      "primarySourceUrl": null,
      "unverifiedClaims": "Operator-to-swarm ratios and multidomain integration are state-linked contractor/institute claims relayed by press — reported, not demonstrated; grade per the parade rule: evidence of priority and direction, not of fielded performance.",
      "dateLastChecked": "2026-09-18"
    },
    {
      "date": "2026-09-08",
      "out": "United24 Media",
      "ttl": "Ukraine's Ground Robots Complete 112,000 Logistics and Evacuation Missions in 2026",
      "sum": "Per data attributed to Ukraine's DELTA battlefield-management system, ground robots have completed ~112,000 logistics and casualty-evacuation missions since January 2026 — over 25,000 in August alone — with ~25,000 UGVs contracted in H1 2026 (double the 2025 total) toward a stated goal of moving 100% of frontline logistics off soldiers; a Ukrainian armed-forces institute study is cited claiming ~30% casualty reduction where UGVs operate.",
      "tech": [
        "robo"
      ],
      "pf": "P7",
      ...
      "saved": false,
      "flagged": true,
      "sourceType": "state_linked",
      "corroborated": false,
      "confidence": "moderate",
      "primarySourceUrl": null,
      "unverifiedClaims": "Ukrainian state-adjacent outlet relaying official DELTA figures; mission counts and the 30% casualty-reduction study are not independently audited. Date approximate. Scale trend is consistent with independent reporting (Defense News, Forecast International).",
      "dateLastChecked": "2026-09-18"
    },
    {
      "date": "2026-09-03",
      "out": "CBS News",
      "ttl": "What weapons China showed off in its military parade as Xi Jinping, Vladimir Putin and Kim Jong Un watched",
      "sum": "The PLA's V-Day parade in Beijing displayed GJ-11 stealth attack drones presented as capable of flying alongside manned fighters, an AJX002 extra-large unmanned underwater vehicle, high-energy-laser counter-drone systems, electronic-jamming systems, counter-unmanned equipment and new hypersonic and strategic missiles, with the Russian and DPRK leaders in attendance — a state-orchestrated capability reveal and deterrence communication.",
      "tech": [
        "robo",
        "ai",
        "dews"
      ...
      "confidence": "high",
      "primarySourceUrl": null,
      "unverifiedClaims": "Event and display independently corroborated (Western press pool coverage); individual systems’ fielded status and performance are paraded claims — reported, not demonstrated.",
      "dateLastChecked": "2026-09-05"
    },
    {
      "date": "2026-09-02",
      "out": "DefenseScoop",
      "ttl": "Army awards AeroVironment nearly $500M contract for laser weapons",
      "sum": "The Army awarded AeroVironment a $464.8M contract under the Enduring-High Energy Laser (E-HEL) program for LOCUST X3 30kW counter-drone laser systems (Group 1–3 defeat, JLTV-mountable or palletised) — reported as the first production contract for high-energy laser weapon systems in US history, following JIATF-401-led testing at White Sands. HEL counter-drone crosses from prototype/pilot to a funded production line.",
      "tech": [
        "dews",
        "robo"
      ],
      ...
      "corroborated": true,
      "confidence": "high",
      "primarySourceUrl": "https://www.avinc.com/2026/09/02/avs-locust-selected-for-nearly-500-million-army-counter-uas-contract-for-enduring-high-energy-laser-e-hel-program/",
      "unverifiedClaims": "Award and value corroborated (vendor release + trade press). Fielded performance at production scale remains to be demonstrated — a production contract is a resourcing fact, not an effectiveness fact.",
      "dateLastChecked": "2026-09-18"
    },
    {
      "date": "2026-09-02",
      "out": "War on the Rocks",
      "ttl": "Ukraine's Ground Robots and the Economics of Survival",
      "sum": "Analysis of fielded Ukrainian practice: in a brigade with a dedicated ground-robot battalion, roughly 19 of every 20 UGV tasks are logistics or casualty evacuation, with combat accounting for only ~2% — the clearest quantified evidence yet that sustainment and evacuation, not strike, are the dominant operational employment of ground robots under contested conditions.",
      "tech": [
        "robo"
      ],
      "pf": "P7",
      ...
      "confidence": "moderate",
      "primarySourceUrl": null,
      "unverifiedClaims": "Article date approximate; task-share figures are unit-reported via the authors, not independently audited.",
      "dateLastChecked": "2026-09-05"
    },
    {
      "date": "2026-08-21",
      "out": "The Army (army.mil)",
      "ttl": "JIATF-401 Counter-UAS and Critical Infrastructure Protection Media Roundtable",
      "sum": "Official roundtable transcript: the Army is running a directed-energy pilot spanning high-energy lasers and high-power microwaves for drone defeat, testing tangible commercial products in small quantities iteratively — with stated goals of a two-drone teaming flight within 60 days and autonomous swarming behaviour within 120 days.",
      "tech": [
        "dews",
        "robo"
      ],
      ...
      "corroborated": true,
      "confidence": "high",
      "primarySourceUrl": "https://www.army.mil/article/294836/jiatf_401_counter_uas_and_critical_infrastructure_protection_media_roundtable_august_21_2026",
    ...
    },
    {
      ...
      "out": "Meduza (citing WSJ)",
      "ttl": "WSJ: Ukrainian drone operators 'easily defeated' U.S. troops in military exercise",
      "sum": "At Combined Resolve (Hohenfels, Apr-May), Ukraine's 412th Unmanned Systems Regiment repeatedly 'destroyed' a ~3,500-strong US armored brigade combat team with recon-cued FPV and bomber drones; US units improved over two weeks through dispersal, concealment, EW and counter-drone systems.",
      "tech": [
        "robo"
      ],
      "pf": "P5",
    ...
    },
    {
      ...
      "out": "Aviation Week",
      "ttl": "Pentagon Wants Lighter Directed-Energy Weapons For Airborne Use",
      "sum": "The Pentagon's assistant secretary for critical technologies called for smaller, lighter, more efficient directed-energy systems for aircraft and high-altitude platforms (counter-drone, expeditionary, SOF, counter-C2), plus routine realistic field testing with operating units and better sensor fusion to pair DE with kinetic and non-kinetic options — naming the transition hurdles beyond raw power.",
      "tech": [
        "dews"
      ],
      "pf": "P5",
    ...
    },
    {
      ...
      "out": "The Korea Herald",
      "ttl": "Army seeks to automate field maintenance as staff shrinks",
      "sum": "South Korea's Army Headquarters commissioned a study to automate field maintenance and logistics (AI predictive maintenance with small language models, maintenance robots, exoskeletons, automated storage, drone delivery, autonomous transport) under ArmyTiger L, driven by a sustained decline in available personnel; the 1st Supply Group unveiled a smart logistics centre with ~70% of processes automated.",
      "tech": [
        "ai",
        "robo",
        "data"
    ...
    },
    {
      ...
      "out": "South China Morning Post",
      "ttl": "Satellite images show 50 per cent boost to China's Type 054B missile capacity",
      "sum": "Commercial imagery (Vantor, 28 Jun) of Hudong-Zhonghua shipyard indicates the third Type 054B frigate is being fitted with 48 VLS cells versus 32 on the first two hulls — a 50% missile-capacity increase on the PLAN's newest frigate class.",
      "tech": [
        "dews"
      ],
      "pf": "P2",
      ...
      "confidence": "high",
      "primarySourceUrl": null,
      "unverifiedClaims": "Body behind paywall; imagery analysis corroborated by Bloomberg (12 Aug) and consistent with Janes construction reporting.",
      "dateLastChecked": "2026-08-17"
    },
    {
      "date": "2026-08-12",
      "out": "GovCIO Media & Research",
      "ttl": "Military Leaders Say AI Needs Better Data to Reach the Battlefield",
      "sum": "At DoDIIS Worldwide (11 Aug), US military intelligence leaders said the biggest obstacle to battlefield AI is not the technology but giving AI access to the data it needs inside the right security enclaves — data access, cybersecurity and resilient infrastructure determine how quickly AI delivers operational advantage.",
      "tech": [
        "data",
        "ai"
      ],
    ...
    },
    {
      "date": "2026-08-12",
      "out": "The Defense Post",
      "ttl": "US Seeks New Hypersonic Cruise Missile for Affordable Mass Production",
      "sum": "DARPA's Next Generation Hypersonic Cruise Missile RFI (issued 7 Aug, responses due 6 Oct) seeks air-breathing designs launchable from air, ground or surface platforms with design-for-manufacturing from the outset — explicitly prioritising affordable high-rate production and magazine depth over exotic one-off capability.",
      "tech": [
        "dews"
      ],
      "pf": "X",
      "desk": "US",
      "url": "https://thedefensepost.com/2026/08/12/us-seeks-hypersonic-cruise-missile/",
      "f": "verified",
      "serial": null,
      "saved": false,
      "flagged": false,
    ...
    },
    {
      ...
      "out": "Naval News",
      "ttl": "HII Watcher Autonomous USV Passes Critical DIU Performance Tests",
      "sum": "DIU recognised completion of HII's PRIME prototype project: the Watcher sUSV (ROMULUS-25 hull, Odyssey autonomy) passed government-led autonomy, seakeeping, performance and degraded-environment assessments — demonstrating autonomous transit through contested waterspace, loiter surveillance and sprint interdiction of a non-cooperative vessel — and is positioned for potential transition to production for the Marine Corps.",
      "tech": [
        "robo",
        "ai"
      ],
      ...
      "corroborated": true,
      "confidence": "high",
      "primarySourceUrl": "https://www.hii.com/news/hiimetalcraft-marine-autonomous-romulus-usv-with-hii-autonomy-successfully-passed-a-critical-dow-test",
      "unverifiedClaims": null,
      "dateLastChecked": "2026-08-17"
    },
    {
      ...
      "out": "Defence Industry Europe",
      "ttl": "Lockheed Martin expands AI-driven military logistics from F-35 to F-22, F-16 and C-130 fleets",
      "sum": "Lockheed Martin is extending its AI sustainment dashboard (parts-health forecasting, predictive maintenance, supply forecasting from real-time consumption, operating profiles and projected mission demand) from the F-35 to F-22, F-16 and C-130 fleets — vendor evidence of sustainment AI crossing from one programme to fleet-wide practice.",
      "tech": [
        "ai",
        "data"
      ],
      ...
      "corroborated": false,
      "confidence": "moderate",
      "primarySourceUrl": "https://www.lockheedmartin.com/en-us/news/features/2026/ai-powered-sustainment--turning-complexity-into-readiness.html",
      "unverifiedClaims": "Vendor-described capability claims; no independent performance validation cited.",
      "dateLastChecked": "2026-08-17"
    },
    {
      "date": "2026-08-10",
